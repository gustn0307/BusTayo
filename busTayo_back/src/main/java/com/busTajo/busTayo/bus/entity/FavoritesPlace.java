...
public class FavoritesPlace extends BaseEntity {
    @Id
    ...
    private String placeId; // 카카오맵 API에서 받아오는 장소 ID
    ...
    private String categoryName; // 카카오 카테고리 이름 (예: "서비스,산업 > 인터넷,IT > 포털서비스")

    @Column(nullable = false, columnDefinition = "DECIMAL(13,10)", name = "place_x")
    private Double placeX; // 장소 경도(Longitude)

    @Column(nullable = false, columnDefinition = "DECIMAL(13,10)", name = "place_y")
    private Double placeY; // 장소 위도(Latitude)
}