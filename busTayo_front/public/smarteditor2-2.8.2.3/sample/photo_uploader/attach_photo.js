    ...
    function html5Upload() {	
    	...
    	sUploadURL= 'http://localhost:8080/api/editor/upload'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : 'http://localhost:8080/api/editor/upload',	//샘플 URL입니다. -> 변경
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
	...
	window.onload = function(){
  		bSupportDragAndDropAPI = false; // 강제로 일반 업로드 방식만 사용
